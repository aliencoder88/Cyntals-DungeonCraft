...
/*
 * Draws the Stonekeep Low Dungeon Chest inventory screen.
 *
 * The menu controls the slots and item movement.
 * This class controls the visual appearance.
 */
public class StonekeepLowDungeonChestScreen
        extends AbstractContainerScreen<
        StonekeepLowDungeonChestMenu
        > {
    ...
    /*
     * Treasure Chest 2.0 uses five rows of nine slots.
     */
    private static final int CHEST_ROWS = 5;

    public StonekeepLowDungeonChestScreen(
            StonekeepLowDungeonChestMenu menu,
    ...
    public void extractBackground(
        ...
        /*
         * Draw the title area and the five chest rows
