...
/*
 * Connects the Stonekeep Low Dungeon Chest's 45 slots
 * to the player's inventory.
 */
public class StonekeepLowDungeonChestMenu
        extends AbstractContainerMenu {

    /*
     * The chest uses 5 rows of 9 slots.
     */
     ...
     * into the menu slots.
     */
    public StonekeepLowDungeonChestMenu(
            int containerId,
    ...
    /*
     * Adds five rows of nine chest slots.
     */
